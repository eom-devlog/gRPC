...
namespace Chat {
  public static partial class ChatService
  {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    static readonly grpc::Method<global::Chat.ChatMessage, global::Chat.ChatMessage> __Method_Chat = new grpc::Method<global::Chat.ChatMessage, global::Chat.ChatMessage>(
    ...
    {
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task Chat(grpc::IAsyncStreamReader<global::Chat.ChatMessage> requestStream, grpc::IServerStreamWriter<global::Chat.ChatMessage> responseStream, grpc::ServerCallContext context)
      {
    ...
    public partial class ChatServiceClient : grpc::ClientBase<ChatServiceClient>
    {
      ...
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual grpc::AsyncDuplexStreamingCall<global::Chat.ChatMessage, global::Chat.ChatMessage> Chat(grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return Chat(new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual grpc::AsyncDuplexStreamingCall<global::Chat.ChatMessage, global::Chat.ChatMessage> Chat(grpc::CallOptions options)
      {
    ...
    {
      serviceBinder.AddMethod(__Method_Chat, serviceImpl == null ? null : new grpc::DuplexStreamingServerMethod<global::Chat.ChatMessage, global::Chat.ChatMessage>(serviceImpl.Chat));
    }
